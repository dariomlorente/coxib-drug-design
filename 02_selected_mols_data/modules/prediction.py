...
from ._paths import INPUTS, INPUT_IC50, CLUSTERING_INTERIM

DEFAULT_IC50_SUMMARY = INPUT_IC50
DEFAULT_IC50_OUTPUT_DIR = CLUSTERING_INTERIM
...
def merge_ic50_summary(
    cox1_csv: str | Path = "data/protein/ic50/CHEMBL221_ic50.csv",
    cox2_csv: str | Path = "data/protein/ic50/CHEMBL230_ic50.csv",
    output_csv: str | Path = "data/protein/ic50/ChEMBL_IC50nSI.csv",
...
def find_chembl_ids_by_smarts(
    ...
    output_csv: str | Path = "data/protein/ic50/ChEMBL_IC50nSI_smarts.csv",
