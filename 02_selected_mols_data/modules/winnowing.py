...
from ._paths import P1_OUTPUTS, INPUT_IC50, QSAR_DIR, QED_DIR, QED_CACHE, CLUSTERING_INPUTS, CLUSTERING_REJECTED
...
def find_latest_stage_csv(
    ...
    filter_mode
        Suffix mode in filenames. If empty, uses ``{stage_name}_*cmpds.csv`` pattern.
...
def load_generated_product_sets(
    ...
    filter_mode
        Input mode used in file naming (empty for Phase 1 outputs naming).
    print_report
